...
PopMax=500  # Insert maximum population size the model should consider
cat(paste("Maximum likely population size set at ",PopMax),"\n")
rem1<- Fit.RemMon(data, PopMax)
...
text(1,rem1["Nresid",1]+3,paste("residual pop now ",round(rem1["Nresid",1],1)),cex=0.8)
